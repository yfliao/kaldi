...
# 1c is as 1b but every settings follow swbd/s5c/local/chain/tuning/run_tdnn_7q.sh after the tree building stage.
...
if [ $stage -le 11 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    --cmd "$decode_cmd" \
    --feat.online-ivector-dir exp/nnet3${nnet3_affix:+_$nnet3_affix}/ivectors_${train_set} \
